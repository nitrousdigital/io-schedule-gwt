...
public class SessionTrackView extends Composite implements ToolbarEnabledWidget {
	...
	private SessionTrackController controller;
	public SessionTrackView(int width, int height) {
		width -= 20;
		VerticalPanel layout = new VerticalPanel();
		layout.setStyleName("sessionTrackList");
	...
	public SessionTrackController getController() {
		return controller;
	}

	public void setController(SessionTrackController controller) {
